...
# --- Cargar datos ---
clientes = pd.read_csv('../data/raw/oot_clientes_sample.csv')
requerimientos = pd.read_csv('../data/raw/oot_requerimientos_sample.csv')
...
# --- Exportar a CSV ---
df_final.to_csv('../data/pre-processed/oot_clientes_features.csv', index=False)
